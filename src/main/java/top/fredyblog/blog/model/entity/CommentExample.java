...
public class CommentExample {
    ...
    protected abstract static class GeneratedCriteria {
        protected List<Criterion> commentTimeCriteria;
        ...
        protected GeneratedCriteria() {
            ...
            commentTimeCriteria = new ArrayList<>();
            createTimeCriteria = new ArrayList<>();
            updateTimeCriteria = new ArrayList<>();
            delTimeCriteria = new ArrayList<>();
        }

        public List<Criterion> getCommentTimeCriteria() {
            return commentTimeCriteria;
        }

        protected void addCommentTimeCriterion(String condition, Object value, String property) {
            if (value == null) {
                throw new RuntimeException("Value for " + property + " cannot be null");
            }
            commentTimeCriteria.add(new Criterion(condition, value, "org.apache.ibatis.type.LocalDateTimeTypeHandler"));
            allCriteria = null;
        }

        protected void addCommentTimeCriterion(String condition, LocalDateTime value1, LocalDateTime value2, String property) {
            if (value1 == null || value2 == null) {
                throw new RuntimeException("Between values for " + property + " cannot be null");
            }
            commentTimeCriteria.add(new Criterion(condition, value1, value2, "org.apache.ibatis.type.LocalDateTimeTypeHandler"));
            allCriteria = null;
        }
        ...
        public List<Criterion> getAllCriteria() {
            if (allCriteria == null) {
                ...
                allCriteria.addAll(commentTimeCriteria);
        ...
        public Criteria andCommentTimeEqualTo(LocalDateTime value) {
            addCommentTimeCriterion("comment_time =", value, "commentTime");
            return (Criteria) this;
        }
        ...
        public Criteria andCommentTimeIn(List<LocalDateTime> values) {
            addCommentTimeCriterion("comment_time in", values, "commentTime");
            return (Criteria) this;
        }

        public Criteria andCommentTimeNotIn(List<LocalDateTime> values) {
            addCommentTimeCriterion("comment_time not in", values, "commentTime");
            return (Criteria) this;
        }

        public Criteria andCommentTimeBetween(LocalDateTime value1, LocalDateTime value2) {
            addCommentTimeCriterion("comment_time between", value1, value2, "commentTime");
            return (Criteria) this;
        }

        public Criteria andCommentTimeNotBetween(LocalDateTime value1, LocalDateTime value2) {
            addCommentTimeCriterion("comment_time not between", value1, value2, "commentTime");
            return (Criteria) this;
        }
