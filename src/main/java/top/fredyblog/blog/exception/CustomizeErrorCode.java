...
public enum CustomizeErrorCode implements ICustomizeErrorCode {
    ...
    TAG_DELETE_FAILED(3002, "标签删除失败"),
    TAG_UPDATE_FAILED(3003, "标签更新失败"),
    TAG_INSERT_FAILED(3004, "标签插入失败"),
    TYPE_NOT_FOUND(4001, "类型不存在"),
    TYPE_DELETE_FAILED(4002, "类型删除失败"),
    TYPE_UPDATE_FAILED(4003, "类型更新失败"),
    TYPE_INSERT_FAILED(4004, "类型插入失败"),
    USER_NOT_FOUND(5001, "用户不存在"),
    USER_DELETE_FAILED(5002, "用户删除失败"),
    USER_UPDATE_FAILED(5003, "用户更新失败"),
    USER_INSERT_FAILED(5004, "用户插入失败"),
    ;
